...
#+BEGIN_SRC emacs-lisp
  (use-package elfeed
    ...
    (evil-define-key 'normal elfeed-search-mode-map
      ...
      "ö" 'tsl-elfeed-search-untag-all-unread-go-up
  ...
  (defalias 'tsl-elfeed-search-untag-all-unread-go-up
    (elfeed-expose #'tsl-elfeed-search-untag-all-go-up 'unread)
    "Remove the `unread' tag from all selected entries. Go to previous line.")

  (defun tsl-elfeed-search-untag-all-go-up (tag)
    ...
    (let ((entries (elfeed-search-selected)))
      ...
      (unless (use-region-p) (previous-line))))
